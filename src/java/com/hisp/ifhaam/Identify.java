...
public class Identify {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Path("{fid}")
    public String deleteJson(@PathParam("fid") String fid){
        System.out.println("FID to Delete : " +fid);
        return FingerPrintApplicationServerInstance.getInstance().delete(fid);
    }
}
