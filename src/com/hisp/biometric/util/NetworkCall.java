...
import com.hisp.biometric.models.OrgunitResponse;
...
public class NetworkCall {
    ...
    public static String ORGUNIT_URL_SUFFIX = "/api/organisationUnits/";
    public static String ORGUNIT_URL;
    ...
    public static void init(){
        ...
        ORGUNIT_URL = dhisDomain+ORGUNIT_URL_SUFFIX;
        String tscheme = dhisDomain.substring(0,dhisDomain.indexOf(":"));
        if(tscheme.length()==4 || tscheme.length()==5) HTTPSCHEME = tscheme;
        System.out.println("Api Url "+apiUrl);
        System.out.println("Dhis RegisterUrl :"+dhisRegisterUrl);
        System.out.println("TEI from cc url  :"+TEI_FROM_CLIENT_CODE);
        System.out.println("Dhis TEI Url :"+DHIS_TEI_URL);
        System.out.println("DASHBoard Url :"+DASHBOARD_URL);
        System.out.println("TEI from Fid Url :"+TEI_FROM_FID_URL);
    ...
    //request sent to fingerprint server 
    public static FingerPrint deleteFingerprint(FingerPrint fp)throws NetworkException{
       CloseableHttpClient httpclient = HttpClients.createDefault();
        ...
        try{
            ...
            HttpDelete request = new HttpDelete(apiUrl+"/"+fp.getFid());
            System.out.println("Delete -> "+apiUrl+"/"+fp.getFid());
            ...
            if(response.getStatusLine().getStatusCode()==200){
                ...
                System.out.println("Delete Request : "+request.toString());
    ...
    //request sent to dhis server
    public static OrgunitResponse getOrgunitDetails(String orgUnitId) throws NetworkException{
        ...
        CloseableHttpClient httpclient = HttpClients.createDefault();
        OrgunitResponse orResponse = null;
        String url = ORGUNIT_URL+orgUnitId+".json";
        try{
            
            HttpGet request = new HttpGet(url);
            System.out.println("Recoginze -> "+url);
            request.setHeader("Content-type","application/json");
           ...
           // request.setHeader("Content-type","application/json");
            ...
            if(response.getStatusLine().getStatusCode()==200){
                ...
                //}
                String responseStr = EntityUtils.toString(response.getEntity());
                System.out.println("Orgunit Response"+responseStr);
                orResponse = OrgunitResponse.fromJson(responseStr);
