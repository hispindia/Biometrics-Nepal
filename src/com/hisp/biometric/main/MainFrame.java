...
//    private void disableandClearInputs(boolean clearFlags){
        ...
        btnVerify.setVisible(false);
                btnClose.addActionListener(new ActionListener(){
                    ...
                    public void actionPerformed(ActionEvent e) {
                        FreeSensor();
			textArea.setText("Device disconnected successfully.");
                    ...
                    public void actionPerformed(ActionEvent e) {
                        if(bIdentify){
                            ...
                            if(tei!=null){
                                ...
                                FingerPrint responseDelete = null;
                                int showConfirmDialog = JOptionPane.showConfirmDialog(MainFrame.this," Patient Registration not"
                                        + " found for the fingerprint. Do you want to delete the fingerprint enrollment ?","Confirm",JOptionPane.YES_NO_OPTION);
                                if(showConfirmDialog==JOptionPane.YES_OPTION){
                                    try {
                                       responseDelete =  NetworkCall.deleteFingerprint(lastFp);
                                    } catch (NetworkException ex) {
                                ...
                                if(responseDelete!=null && responseDelete.getFid()==lastFp.getFid()){
                                    JOptionPane.showMessageDialog(MainFrame.this, "Fingerprint removed from the system ","Success",JOptionPane.INFORMATION_MESSAGE);
                                    btnRegister.setEnabled(false);
                                }else{
                                    JOptionPane.showMessageDialog(MainFrame.this, "Fingerprint removing failed.","Success",JOptionPane.INFORMATION_MESSAGE);
                                }
                        ...
                        if(!txtName.getText().equals("")){
                            ...
                            try{
                                ...
                                return;
                                 ...
                                 textArea.setText("UnknownException.. try again");
                                JOptionPane.showMessageDialog(MainFrame.this, ex.getMessage(),"Error",JOptionPane.ERROR_MESSAGE);
                                return;
                            }
                            if(tei!=null){
                                ...
                                try{
                                    OrgunitResponse orResp = NetworkCall.getOrgunitDetails(tei.getOrgUnit());
                                    //textArea.setText("Patient found \n Patient \t:"+tei.getLastName() +"\n ,Client Code \t:"+tei.getCode()+", was registered at "+tei.getOrgUnit());
                                    textArea.setText("Patient found with "+tei.getCode()
                                            +" and was registered at "+orResp.getDisplayName());
                                    teiValidated = tei;
                                    btnRegister.setEnabled(true);
                                }catch(NetworkException ex){
                    ...
                    if (0 == (ret = FingerprintSensorEx.DBMerge(mhDB, regtemparray[0], regtemparray[1], regtemparray[2], regTemp, _retLen))) {//&&
                        ...
                        if(fp==null){
                            ...
                            if(fp==null){
                                ...
                                textArea.setText("Fingerprint enrolled. Click on register/update");
                                lastFp = fp;
                                rdUpdate.setSelected(false);
                                rdNew.setSelected(false);
                                rdNew.setEnabled(true);
