            ...
            if(bRegister)
            {
                ...
                if (enroll_idx == 3) {
                    ...
                    if (0 == (ret = FingerprintSensorEx.DBMerge(mhDB, regtemparray[0], regtemparray[1], regtemparray[2], regTemp, _retLen))) {//&&
                        ...
                        // commented after final test adding network exceptionfp = NetworkCall.recognize(regTempStr);
                        if(fp==null){
                            ...
                            // commented after final test adding network exceptionfp fp = NetworkCall.sendEnrollment(regTempStr);
                            if(fp==null){
                                textArea.setText("Error connecting to Server...");
                            }else if(fp.getFid()==-1){
                ...
                FingerPrint fp = new FingerPrint();
                // commented after final test adding network exceptionfp fp = NetworkCall.recognize(templateStr);
                if(fp==null){
                    textArea.setText("Error connecting to Server...");
                }else if(fp.getFid()!=-1){
